...
import com.example.pdca.fragments.*
import com.google.android.material.tabs.TabLayout
import timber.log.Timber

class ContentsActivityViewPagerAdapter(
    fm: FragmentManager,
    ...
    override fun getItem(position: Int): Fragment {
        ...
        return when (position) {
            0 -> ContentsPlanFragment.newInstance(
                id,
                number
            )
            1 -> ContentsDoFragment.newInstance()
            2 -> ContentsCheckFragment.newInstance()
            3 -> ContentsActionFragment.newInstance()
